...
namespace TicketStationMVC.Migrations
{
    ...
    [Migration("20241230134351_roles-update1")]
            ...
            modelBuilder.Entity("TicketStationMVC.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Administrator",
                            Password = "$2a$11$DcBu.KaSBRLBS1OpOFztYeyszh3BxPSLmNnhmN3eWElN7q3E/EXba",
                            RegisteredOn = new DateTime(2024, 12, 30, 15, 43, 50, 191, DateTimeKind.Local).AddTicks(2184),
                            RoleId = 1,
                            Username = "admin"
                        });
                });
