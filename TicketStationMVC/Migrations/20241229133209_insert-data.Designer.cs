...
namespace TicketStationMVC.Migrations
{
    ...
    [Migration("20241229133209_insert-data")]
            ...
            modelBuilder.Entity("TicketStationMVC.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Administrator",
                            Password = "$2a$11$Kd108Qj9L7t7OFVJPSb5y.OAPeI53v5edkrzmv4fp98n92dOuSCku",
                            RegisteredOn = new DateTime(2024, 12, 29, 15, 32, 9, 532, DateTimeKind.Local).AddTicks(4183),
                            RoleId = 1,
                            Username = "admin"
                        });
                });
