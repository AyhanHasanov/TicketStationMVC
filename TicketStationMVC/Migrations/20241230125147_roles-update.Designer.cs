...
namespace TicketStationMVC.Migrations
{
    ...
    [Migration("20241230125147_roles-update")]
            ...
            modelBuilder.Entity("TicketStationMVC.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Administrator",
                            Password = "$2a$11$Pmz5VbruYIhTcYM6ScT/qun3z8GjhFcNkqmGdJ6685.uyIpvl7tcW",
                            RegisteredOn = new DateTime(2024, 12, 30, 14, 51, 46, 870, DateTimeKind.Local).AddTicks(9428),
                            RoleId = 1,
                            Username = "admin"
                        });
                });
